...
Процедура ТестДолжен_ВывестиИзмененияЗависимостейВJson() Экспорт
	...
	Ожидаем.Что(ПроверяемыйОбъект).ИмеетДлину(4);
	...
	Ожидаем.Что(ПроверяемыйОбъект[1].packageName, "[1].packageName").Равно("autumn");
	Ожидаем.Что(ПроверяемыйОбъект[1].isDev, "[1].isDev").Равно(Ложь);
	Ожидаем.Что(ПроверяемыйОбъект[1].minVersionBefore, "[1].minVersionBefore").Равно("3.2.0");
	Ожидаем.Что(ПроверяемыйОбъект[1].minVersionAfter, "[1].minVersionAfter").Равно("4.3.11");
	Ожидаем.Что(ПроверяемыйОбъект[1].maxVersion, "[1].maxVersion").Равно("4.4.1");

	Ожидаем.Что(ПроверяемыйОбъект[2].packageName, "[2].packageName").Равно("packageinfo");
	Ожидаем.Что(ПроверяемыйОбъект[2].isDev, "[2].isDev").Равно(Ложь);
	Ожидаем.Что(ПроверяемыйОбъект[2].minVersionBefore, "[2].minVersionBefore").Равно("0.7");
	Ожидаем.Что(ПроверяемыйОбъект[2].minVersionAfter, "[2].minVersionAfter").Равно("0.8");
	Ожидаем.Что(ПроверяемыйОбъект[2].maxVersion, "[2].maxVersion").Равно("");

	Ожидаем.Что(ПроверяемыйОбъект[3].packageName, "[3].packageName").Равно("1testrunner");
	Ожидаем.Что(ПроверяемыйОбъект[3].isDev, "[3].isDev").Равно(Истина);
	Ожидаем.Что(ПроверяемыйОбъект[3].minVersionBefore, "[3].minVersionBefore").Равно("1.8.0");
	Ожидаем.Что(ПроверяемыйОбъект[3].minVersionAfter, "[3].minVersionAfter").Равно("1.9.2");
