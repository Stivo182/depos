...
Функция ПолучитьАнализаторПрочитанныйИзФайла()
	...
	Возврат Поделка.НайтиЖелудь("АнализаторЗависимостей")
		...
		.УстановитьИсходники("src")
		.УстановитьСлужебныеИсходники("tests");
...
Функция ПолучитьАнализаторПрочитанныйИзТаблицы()
	...
	Возврат Поделка.НайтиЖелудь("АнализаторЗависимостей")
		...
		.УстановитьИсходники("./tests/fixtures/ПроектДляАнализа/src")
		.УстановитьСлужебныеИсходники("./tests/fixtures/ПроектДляАнализа/tests");
