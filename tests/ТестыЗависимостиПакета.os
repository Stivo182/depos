...
&Тест
Процедура ТестДолжен_ЗаполнитьЗависимостиИзФайлаМанифеста() Экспорт
	
	// Подготовка
	Зависимости = Новый ЗависимостиПакета();

	Манифесты = Новый Массив();
	Манифесты.Добавить(ПомощникТестирования.ФайлМанифеста);
	Манифесты.Добавить(ПомощникТестирования.ФайлМанифестаOpmMetadata);

	Для Каждого Файл Из Манифесты Цикл

		// Действие
		Результат = Зависимости.ЗаполнитьИзМанифеста(Файл).СкопироватьВТаблицу();
...
Процедура ТестДолжен_ПолучитьОшибкуПриЧтенииОшибочногоМанифеста() Экспорт
	...
	Ожидаем.Что(Зависимости)
		.Метод("ЗаполнитьИзМанифеста", Параметры)
...
&Тест
Процедура ТестДолжен_ЗаполнитьЗависимостиИзФайлаМанифестаБезТиреВИмениКлючей() Экспорт
	
	// Подготовка
	Зависимости = Новый ЗависимостиПакета();

	// Действие
	Результат = Зависимости.ЗаполнитьИзМанифеста("./tests/fixtures/opm-metadata-no-dashes.xml").СкопироватьВТаблицу();
...
&Тест
Процедура ТестДолжен_ЗаполнитьЕдинственнуюЗависимостьИзФайлаМетаданных() Экспорт
	...
	// Действие
	Результат = Зависимости
		.ЗаполнитьИзМанифеста("./tests/fixtures/ПроектСТранзитивнымиКонфликтами/oscript_modules/root_a/opm-metadata.xml")
		.СкопироватьВТаблицу();
