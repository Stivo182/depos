...
&Тест
Процедура ТестДолжен_ПрочитатьЗависимостиИзФайлаМанифеста() Экспорт
	...
	Для Каждого Файл Из Манифесты Цикл
		...
		// Действие
		Результат = Зависимости.ПрочитатьИзМанифеста(Файл).ВТаблицу();
...
&Тест
Процедура ТестДолжен_ПрочитатьЗависимостиИзТаблицы() Экспорт
...
&Тест
Процедура ТестДолжен_ОтфильтроватьЗависимостиПоИмениПакета() Экспорт
...
&Тест
Процедура ТестДолжен_ПрочитатьФайлМанифестаБезТиреВИмениКлючей() Экспорт
	
	// Подготовка
	Зависимости = Новый ЗависимостиПакета();

	// Действие
	Результат = Зависимости.ПрочитатьИзМанифеста("./tests/fixtures/opm-metadata-no-dashes.xml").ВТаблицу();
