...
// 1. Параметр КаталогБиблиотек (если указан)
...
//
// Параметры:
//  КаталогБиблиотек - Строка - Путь к каталогу библиотек для поиска.
//                              Если не указан, используются каталоги из конфигурации
//
