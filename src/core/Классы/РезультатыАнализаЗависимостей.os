...
Функция ПустаяТаблицаОтсутствующихПакетов()
	...
	Результат.Колонки.Добавить("ИмяПакета", ОписаниеТипаСтрока());
	Результат.Колонки.Добавить("ДляРазработки", ОписаниеТипаБулево());
...
Функция ПустаяТаблицаКонфликтовВерсийУстановленныхПакетов()
	...
	Результат.Колонки.Добавить("ИмяПакета", ОписаниеТипаСтрока());
	Результат.Колонки.Добавить("ДляРазработки", ОписаниеТипаБулево());
	Результат.Колонки.Добавить("ТребуемаяВерсия", ОписаниеТипаСтрока());
	Результат.Колонки.Добавить("УстановленнаяВерсия", ОписаниеТипаСтрока());
	Результат.Колонки.Добавить("Каталог", ОписаниеТипаСтрока());
