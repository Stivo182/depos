...
Процедура Вывести(Зависимости) Экспорт
	...
	Для Каждого СтрокаЗависимости Из Зависимости Цикл
		...
		// Имя пакета
		ЦветнойВывод.Вывести(ФиксированнаяСтрока(СтрокаЗависимости.ИмяПакета, ДлиныКолонок.ИмяПакета, , , Истина));

		// Признак для разработки
		ЦветнойВывод.Вывести(ФиксированнаяСтрока(ТекстДляРазработки, СтрДлина(ТекстДляРазработкиПоУмолчанию), , , Истина));

		ЦветнойВывод.Вывести(" ");

		// Текущая версия
		ЦветнойВывод.Вывести(ФиксированнаяСтрока(МинВерсия, ДлиныКолонок.МинимальнаяВерсия));
