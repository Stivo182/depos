...
&Опция(Имя = "src-dirs", Описание = "Каталоги исходников")
&ТСтрока
&ПоУмолчанию("src")
Перем _КаталогиИсходников; // Строка

&Опция(Имя = "dev-dirs", Описание = "Каталоги служебных исходников")
&ТСтрока
...
Функция ПолучитьКаталогиИсходников()
	Возврат ?(ЗначениеЗаполнено(_НастройкиПриложения.КаталогиИсходников)
				, _НастройкиПриложения.КаталогиИсходников
				, _КаталогиИсходников);
КонецФункции

Функция ПолучитьКаталогиСлужебныхИсходников()
	Возврат ?(ЗначениеЗаполнено(_НастройкиПриложения.КаталогиСлужебныхИсходников),
