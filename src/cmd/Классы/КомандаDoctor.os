...
&Опция(Имя = "ignore-dev", Описание = "Игнорировать зависимости для разработки из анализа")
&Флаг
&ПоУмолчанию(Ложь)
...
Процедура Запустить()
	...
	Если Не _ИгнорироватьЗависимостиДляРазработки Тогда
		АнализаторЗависимостей.УстановитьВспомогательныеКаталогиИсходников(_КаталогиВспомогательныхИсходников);
	Иначе
