...
| Опция | Описание |
| --- | --- |
| --packagedef <путь> | Путь к файлу  `packagedef` или его каталогу (по умолчанию - текущая директория). |
...
| Опция | Описание |
| --- | --- |
| --packagedef <путь> | Путь к файлу `packagedef` или его каталогу.<br>По умолчанию: текущая директория |
| --src-dirs <каталоги> | Каталоги с исходным кодом для анализа (через запятую).<br>По умолчанию: `src`. |
| --dev-dirs <каталоги> | Каталоги с вспомогательным кодом для анализа (через запятую).<br>По умолчанию: `tests` и `tasks`. |
| --ignore-dev | Игнорировать зависимости для разработки из анализа. |
